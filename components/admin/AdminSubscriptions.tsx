...
const AdminSubscriptions: React.FC<AdminSubscriptionsProps> = ({ onNavigate }) => {
  return (
    <AdminLayout onNavigate={onNavigate} activePage="admin-subscriptions" title="Subscriptions & Payments">
