...
const AdminAddBlog: React.FC<AdminAddBlogProps> = ({ onNavigate }) => {
  ...
  if (view === 'success') {
    return (
      <AdminLayout onNavigate={onNavigate} activePage="admin-blog" title="Blog Management">
  ...
  if (view === 'preview') {
    return (
      <AdminLayout onNavigate={onNavigate} activePage="admin-blog" title="Preview Article">
  ...
  return (
    <AdminLayout onNavigate={onNavigate} activePage="admin-blog" title="Add New Article">
