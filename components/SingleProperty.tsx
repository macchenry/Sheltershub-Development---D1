            ...
            <aside className="lg:col-span-4 space-y-6">
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <div className="space-y-3 mb-6">
                         <a 
                            href={showPhone ? `tel:${property.owner.phone}` : '#'}
                         ...
                         >
                            ...
                            {showPhone ? property.owner.phone : 'Call Owner'}
                         </a>
                         ...
                         <a href={`mailto:${property.owner.email}`} className="flex items-center gap-2 bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors text-sm font-bold">
